...
inherit live in sister directories to it.Typically a conversation
...
- `/+suffix` duplicates all the words in the category, adding the suffix
to them. Thus `[say talk]/+ing` is stored as `[say talk saying talking]`.


== Lists
IMPORTANT: Lists are not yet implemented
