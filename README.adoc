...
Here, we set up two 
<<ACTION.adoc#Maps,maps>>, both of which map from categories (the materials) to lists of
...
data, you can do this by having a bot-global <<ACTION.adoc#Maps,map>>, and storing your data there: since it's
